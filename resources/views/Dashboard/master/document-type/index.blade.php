...
@section('content')
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500">
                            Kelola jenis dokumen yang digunakan dalam arsip.
                        </p>
                    </div>
            ...
            <a href="{{ route('sadarin.admin.master.document-type.create') }}"
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            ...
            <form method="GET" action="{{ route('sadarin.admin.master.document-type.index') }}"
                ...
                <div class="relative flex-1">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari jenis dokumen..."
                        ...
                        @forelse($documentTypes as $item)
                            <tr class="transition hover:bg-slate-50">
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    @if ($item->document_type_description)
                                ...
                                <td class="px-5 py-4 text-center">
                                    ...
                                    @if ($item->document_type_is_active)
                                        <span
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <a href="{{ route('sadarin.admin.master.document-type.edit', $item->document_type_id) }}"
                                            title="Edit"
                                        ...
                                        @if ($item->document_type_is_active)
                                            <form
                                                action="{{ route('sadarin.admin.master.document-type.destroy', $item->document_type_id) }}"
                                                method="POST" onsubmit="return confirm('Nonaktifkan jenis dokumen ini?')">
                                ...
                                <td colspan="5" class="px-5 py-12 text-center">
                                    ...
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="mt-1 text-sm text-slate-400">
                                            Silakan tambahkan jenis dokumen baru.
                                        </p>
