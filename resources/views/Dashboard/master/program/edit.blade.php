...
@section('content')
    ...
    <div class="mx-auto max-w-4xl space-y-6">
        ...
        {{-- Form --}}
        <form action="{{ route('sadarin.admin.master.program.update', $program->program_id) }}" method="POST"
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-400">
                            Perbarui informasi program yang dipilih.
                        </p>
            ...
            <div class="space-y-5 p-6">
                ...
                <div>
                    ...
                    <input type="text" id="program_code" name="program_code"
                        value="{{ old('program_code', $program->program_code) }}" maxlength="100"
                        placeholder="Contoh: 2.22.01"
                ...
                <div>
                    ...
                    <input type="text" id="program_name" name="program_name"
                        value="{{ old('program_name', $program->program_name) }}" maxlength="255" required
                        placeholder="Contoh: Program Pengembangan Kebudayaan"
                        class="w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-700 outline-none transition focus:border-[oklch(29.3%_0.136_325.661)] focus:ring-2 focus:ring-[oklch(29.3%_0.136_325.661)]/10">
                ...
                <div>
                    ...
                    <textarea id="program_description" name="program_description" rows="4"
                        ...
                        class="w-full resize-none rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-700 outline-none transition focus:border-[oklch(29.3%_0.136_325.661)] focus:ring-2 focus:ring-[oklch(29.3%_0.136_325.661)]/10">{{ old('program_description', $program->program_description) }}</textarea>
                ...
                <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <label class="flex cursor-pointer items-center gap-3">
                        ...
                        <input type="checkbox" name="program_is_active" value="1"
                            {{ old('program_is_active', $program->program_is_active) ? 'checked' : '' }}
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-400">
                                Program aktif dapat digunakan dalam data arsip.
                            </p>
