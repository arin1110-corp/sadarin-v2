    ...
    <div class="mx-auto max-w-4xl space-y-6">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">
                Tambahkan kegiatan baru dan hubungkan dengan program.
            </p>
        ...
        {{-- Form --}}
        <form action="{{ route('sadarin.admin.master.kegiatan.store') }}" method="POST"
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-400">
                            Isi informasi kegiatan dengan benar.
                        </p>
            ...
            <div class="space-y-5 p-6">
                    ...
                    <select id="kegiatan_program_id" name="kegiatan_program_id" required
                        ...
                        @foreach ($programs as $program)
                            <option value="{{ $program->program_id }}"
                                {{ old('kegiatan_program_id') == $program->program_id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <input type="text" id="kegiatan_code" name="kegiatan_code" value="{{ old('kegiatan_code') }}"
                        maxlength="100" placeholder="Contoh: 2.22.01.1.01"
                        class="w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-700 outline-none transition focus:border-[oklch(29.3%_0.136_325.661)] focus:ring-2 focus:ring-[oklch(29.3%_0.136_325.661)]/10">
                ...
                <div>
                    ...
                    <input type="text" id="kegiatan_name" name="kegiatan_name" value="{{ old('kegiatan_name') }}"
                        maxlength="255" required placeholder="Contoh: Pengelolaan Kebudayaan"
                        class="w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-700 outline-none transition focus:border-[oklch(29.3%_0.136_325.661)] focus:ring-2 focus:ring-[oklch(29.3%_0.136_325.661)]/10">
                ...
                <div>
                    ...
                    <textarea id="kegiatan_description" name="kegiatan_description" rows="4"
                        ...
                        class="w-full resize-none rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-700 outline-none transition focus:border-[oklch(29.3%_0.136_325.661)] focus:ring-2 focus:ring-[oklch(29.3%_0.136_325.661)]/10">{{ old('kegiatan_description') }}</textarea>
                ...
                <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <label class="flex cursor-pointer items-center gap-3">
                        ...
                        <input type="checkbox" name="kegiatan_is_active" value="1" checked
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-400">
                                Kegiatan dapat digunakan dalam data arsip.
                            </p>
