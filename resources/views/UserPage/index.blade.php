...
@section('content')
    ...
    ============================================================= --}}
        ...
        >
            ...
            <div class="pointer-events-none absolute inset-0 overflow-hidden">
                ...
                <div
                    class="absolute -left-32 top-16 h-80 w-80 rounded-full bg-sadarin-100/60 blur-3xl"
                ></div>

                <div
                    class="absolute right-[30%] top-0 h-96 w-96 rounded-full bg-sadarin-100/70 blur-3xl"
                ></div>

                <div
                    class="absolute -bottom-40 right-0 h-[500px] w-[500px] rounded-full bg-sadarin-200/50 blur-3xl"
                ></div>
            ...
            ========================================================= --}}
                ...
                <div class="relative z-10 max-w-2xl">
                    ...
                    >
                        ...
                        <span
                            class="h-1.5 w-1.5 rounded-full bg-sadarin-700"
                        ></span>
                    ...
                    {{-- DESCRIPTION --}}
                    <p
                        class="mt-5 max-w-xl text-base leading-7 text-navy-500 sm:text-[17px]"
                    >
            ...
            ========================================================= --}}
                ...
                <div
                    class="relative flex min-h-[280px] items-center justify-center lg:min-h-[390px]"
                >

                    {{-- IMAGE GLOW --}}
                    <div
                        class="absolute right-[5%] top-[5%] h-[340px] w-[340px] rounded-full bg-sadarin-200/50 blur-3xl"
                    ></div>


                    <img
                        src="{{ asset('assets/images/hero-page.png') }}"
                        alt="Ilustrasi sistem arsip SADARIN"
    ...
    ============================================================= --}}
        ...
        >
            ...
            <div
                class="mx-auto max-w-7xl px-5 py-10 sm:px-8 lg:py-12"
            >
                ...
                <div class="mb-7 flex items-end justify-between gap-4">
                    ...
                    <div>
                        ...
                        <h2
                            class="text-xl font-semibold tracking-[-0.5px] text-navy-900"
                        >
                            Telusuri Arsip
                        </h2>

                        <p class="mt-1 text-sm text-navy-400">
                            Temukan arsip berdasarkan unit, klasifikasi,
                            dan metadata.
                        </p>
                ...
                <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                    ...
                    >
                        ...
                        <div class="flex items-start justify-between">
                            ...
                            <i
                                class="bi bi-arrow-up-right text-slate-300 transition group-hover:text-blue-500"
                            ></i>
                    ...
                    >
                        ...
                        <div class="flex items-start justify-between">
                            ...
                            <i
                                class="bi bi-arrow-up-right text-slate-300 transition group-hover:text-emerald-500"
                            ></i>
                    ...
                    >
                        ...
                        <div class="flex items-start justify-between">
                            ...
                            <i
                                class="bi bi-arrow-up-right text-slate-300 transition group-hover:text-indigo-500"
                            ></i>
                    ...
                    >
                        ...
                        <div class="flex items-start justify-between">
                            ...
                            <i
                                class="bi bi-arrow-up-right text-slate-300 transition group-hover:text-orange-500"
                            ></i>
                    ...
                    >
                        ...
                        <div class="flex items-start justify-between">
                            ...
                            <i
                                class="bi bi-arrow-up-right text-slate-300 transition group-hover:text-red-500"
                            ></i>
                    ...
                    >
                        ...
                        <div class="flex items-start justify-between">
                            ...
                            <i
                                class="bi bi-arrow-up-right text-slate-300 transition group-hover:text-amber-500"
                            ></i>
                    ...
                    >
                        ...
                        <div class="flex items-start justify-between">
                            ...
                            <i
                                class="bi bi-arrow-up-right text-slate-300 transition group-hover:text-sky-500"
                            ></i>
    ...
    ============================================================= --}}
        ...
        >
            ...
            <div
                class="mx-auto max-w-7xl px-5 py-12 sm:px-8 lg:py-14"
            >
                ...
                <div class="mt-6 grid gap-4 lg:grid-cols-3">
                    ...
                    >
                        ...
                        <div
                            class="mt-5 flex flex-wrap gap-2 text-xs text-navy-400"
                        >
                            ...
                            <span class="inline-flex items-center gap-1.5">
                                <i class="bi bi-layers text-sadarin-600"></i>
                                Program Pengembangan Kebudayaan
                            </span>
                        ...
                        <div class="mt-5 flex flex-wrap gap-2">
                            ...
                            <span
                                class="rounded-full bg-slate-100 px-2.5 py-1 text-[11px] text-navy-500"
                            >
                                laporan
                            </span>
                    ...
                    >
                        ...
                        <div class="flex items-start justify-between gap-4">
                            ...
                            <span
                                class="rounded-full bg-slate-100 px-2.5 py-1 text-[11px] font-semibold text-navy-500"
                            >
                                Internal
                            </span>
                        ...
                        >
                            ...
                            <span class="inline-flex items-center gap-1.5">
                                <i class="bi bi-layers text-emerald-600"></i>
                                Program Pengembangan Kebudayaan
                            </span>
                    ...
                    >
                        ...
                        >
                            ...
                            <span class="inline-flex items-center gap-1.5">
                                <i class="bi bi-building text-sky-500"></i>
                                UPTD Taman Budaya
                            </span>
                ...
                <div class="mt-6 sm:hidden">
                    ...
                    <a
                        href="#"
                        class="flex items-center justify-center gap-2 rounded-xl border border-sadarin-200 py-3 text-sm font-semibold text-sadarin-700 transition hover:bg-sadarin-50"
                    >
                        Lihat semua arsip
