...
@section('content')
    ...
    <div class="mx-auto max-w-3xl">
        ...
        {{-- Form --}}
        <form method="POST" action="{{ route('sadarin.admin.master.document-type.update', $documentType->document_type_id) }}">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="document_type_name"
                            value="{{ old('document_type_name', $documentType->document_type_name) }}" maxlength="150"
                            required autofocus
                    ...
                    <div>
                        ...
                        <textarea name="document_type_description" rows="4" placeholder="Deskripsi jenis dokumen (opsional)"
                            class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm outline-none transition focus:border-purple-400 focus:ring-2 focus:ring-purple-100">{{ old('document_type_description', $documentType->document_type_description) }}</textarea>
                    ...
                    <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
                        ...
                        <label class="flex cursor-pointer items-center gap-3">
                            ...
                            <input type="checkbox" name="document_type_is_active" value="1"
                                @checked(old('document_type_is_active', $documentType->document_type_is_active))
                            ...
                            <div>
                                ...
                                <div class="text-xs text-slate-500">
                                    Jenis dokumen aktif dapat dipilih ketika membuat arsip.
                                </div>
