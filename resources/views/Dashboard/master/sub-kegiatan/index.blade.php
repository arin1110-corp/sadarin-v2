...
@section('content')
    ...
    <div class="space-y-6">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500">
                            Kelola data sub kegiatan arsip.
                        </p>
                    </div>
                </div>
            </div>

            <a href="{{ route('sadarin.admin.master.sub-kegiatan.create') }}"
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            ...
            <form method="GET" action="{{ route('sadarin.admin.master.sub-kegiatan.index') }}"
                ...
                <div class="relative flex-1">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}"
                        placeholder="Cari sub kegiatan, kode, atau kegiatan..."
                ...
                <button type="submit"
                    class="inline-flex items-center justify-center gap-2 rounded-xl bg-slate-800 px-5 py-2.5 text-sm font-semibold text-white hover:bg-slate-700">
            ...
            <div class="overflow-x-auto">
                ...
                <table class="min-w-full text-sm">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        @forelse($subKegiatans as $item)
                            <tr class="transition hover:bg-slate-50">

                                <td class="whitespace-nowrap px-5 py-4 text-slate-500">
                                    {{ $subKegiatans->firstItem() + $loop->index }}
                                </td>
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    @if ($item->sub_kegiatan_description)
                                        <div class="mt-1 max-w-md truncate text-xs text-slate-400">
                                            {{ $item->sub_kegiatan_description }}
                                        </div>
                                    @endif
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    <span
                                        class="inline-flex items-center gap-2 rounded-lg bg-orange-50 px-2.5 py-1.5 text-xs font-medium text-orange-700">
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    @if ($item->sub_kegiatan_code)
                                        <span
                                            class="rounded-lg bg-slate-100 px-2.5 py-1.5 font-mono text-xs text-slate-600">
                                ...
                                <td class="px-5 py-4 text-center">
                                    ...
                                    @if ($item->sub_kegiatan_is_active)
                                        <span
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <a href="{{ route('sadarin.admin.master.sub-kegiatan.edit', $item->sub_kegiatan_id) }}"
                                            title="Edit"
                                        ...
                                        @if ($item->sub_kegiatan_is_active)
                                            <form
                                                action="{{ route('sadarin.admin.master.sub-kegiatan.destroy', $item->sub_kegiatan_id) }}"
                                                method="POST" onsubmit="return confirm('Nonaktifkan sub kegiatan ini?')">
                            ...
                            <tr>
                                ...
                                <td colspan="6" class="px-5 py-12 text-center">
                                    ...
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <div
                                            class="mb-3 flex h-14 w-14 items-center justify-center rounded-2xl bg-orange-50 text-orange-500">
                                        ...
                                        <p class="mt-1 text-sm text-slate-400">
                                            Silakan tambahkan sub kegiatan baru.
                                        </p>
