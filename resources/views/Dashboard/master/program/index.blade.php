...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Kelola data program yang digunakan dalam pengelompokan arsip.
                </p>
            </div>

            <a href="{{ route('sadarin.admin.master.program.create') }}"
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            ...
            <form method="GET" action="{{ route('sadarin.admin.master.program.index') }}">
                            ...
                            <tr class="transition hover:bg-slate-50/70">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            @if ($program->program_description)
                                                <p class="mt-0.5 max-w-lg truncate text-xs text-slate-400">
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        {{-- Edit --}}
                                        <a href="{{ route('sadarin.admin.master.program.edit', $program->program_id) }}"
                                            title="Edit"
                                        ...
                                        @if ($program->program_is_active)
                                            <form
                                                action="{{ route('sadarin.admin.master.program.destroy', $program->program_id) }}"
                                                method="POST" onsubmit="return confirm('Nonaktifkan program ini?')">
                                ...
                                <td colspan="5" class="px-5 py-16 text-center">
                                    ...
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="mt-1 text-xs text-slate-400">
                                            Silakan tambahkan program pertama.
                                        </p>
